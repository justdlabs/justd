...
export default function TabsOrientationDemo() {
  return (
    <Tabs orientation="vertical" aria-label="E-Learning Platform">
      ...
      <Tabs.Panel id="c">Enroll in courses and access learning materials on various subjects.</Tabs.Panel>
      ...
      <Tabs.Panel id="f">Participate in discussion forums with other students and instructors.</Tabs.Panel>
