...
export default function TabsDisabledDemo() {
  return (
    <Tabs disabledKeys={['c', 'a']} aria-label="Services">
      ...
      <TabPanel id="f">
        Our features include 24/7 support, real-time analytics, customizable dashboards, and seamless integration with
        your existing tools to enhance your productivity.
      </TabPanel>
      <TabPanel id="p">
        We offer competitive pricing plans to suit your needs, including a free tier, a standard plan for small teams,
        and a premium plan with advanced features for large organizations.
      </TabPanel>
      <TabPanel id="c">
