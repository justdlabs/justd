...
const DropZone = ({ className, ...props }: DropZoneProps) => <DropPrimitiveZone className={composeRenderProps(className, (className, renderProps) => dropZoneStyles({ ...renderProps, className }))} {...props} />
export { DropZone }
