...
const textareaStyles = tv({
  extend: focusStyles,
  base: "w-full min-w-0 rounded-lg border border-input px-2.5 py-2 text-base shadow-xs outline-hidden transition duration-200 data-disabled:opacity-50 sm:text-sm"
})
