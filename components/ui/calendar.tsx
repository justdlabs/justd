...
const CalendarGridHeader = () => {
  return <CalendarGridHeaderPrimitive>{(day) => <CalendarHeaderCell className="text-sm lg:text-xs font-semibold text-zinc-500">{day}</CalendarHeaderCell>}</CalendarGridHeaderPrimitive>
}
