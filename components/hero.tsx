    ...
    <div className="relative isolate overflow-hidden bg-background">
      ...
      >
        <div
          ...
          className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-lime-500 to-primary-500 opacity-10 dark:opacity-20 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
        />
      </div>
      <svg
        aria-hidden="true"
      ...
      <div className="pt-10 pb-6 sm:py-16 md:py-20 lg:py-24 border-b">
        <Container>
          <Header>
            <Heading
              level={1}
              className="max-w-xl text-2xl font-bold tracking-tight lg:text-5xl mb-2 lg:mb-6"
            >
            ...
            <Text className="text-base lg:text-xl max-w-2xl block leading-relaxed text-muted-fg">
              <strong className="text-fg">D.</strong> is a chill set of React components,
              built on top of <strong className="text-fg">React Aria Components</strong>,
              all about keeping the web accessible. Easy to customize and just copy &
              paste into your React projects. Plus, it includes{' '}
