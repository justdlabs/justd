    ...
    <div className="relative isolate overflow-hidden bg-bg">
      ...
      >
        <div
          ...
          className="relative left-[calc(50%-11rem)] aspect-1155/678 w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-linear-to-tr dark:from-sky-500 dark:to-primary-500 opacity-10 dark:opacity-[0.17] sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
        />
      </div>
      <svg
        aria-hidden="true"
