    ...
    <div className="relative isolate overflow-hidden bg-bg">
      ...
      >
        <div
          ...
          className="relative left-[calc(50%-11rem)] aspect-1155/678 w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-linear-to-tr dark:from-indigo-500 dark:to-blue-600 opacity-10 dark:opacity-20 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
        />
      </div>
      <svg
        aria-hidden="true"
        className="absolute lg:block hidden inset-0 -z-10 h-full w-full stroke-fg/10 [mask-image:radial-gradient(100%_100%_at_top_right,white,transparent)]"
      >
        <defs>
          <pattern
            x="50%"
          ...
          <Header>
            <Link
              ...
              className={buttonStyles({
                ...
                appearance: "outline",
                shape: "circle",
                className: "**:data-[slot=icon]:text-warning group bg-white text-zinc-900 hover:bg-zinc-100"
              })}
            >
            ...
            <p className="text-base [&_strong]:font-medium lg:text-xl max-w-3xl block leading-relaxed md:leading-loose text-muted-fg">
