...
## August 20
Remove framer motion from [Tabs](/docs/components/navigations/tabs), [ProgressBar](/docs/components/statuses/progress-bar), [Meter](/docs/components/statuses/progress-bar), and [Accordion](/docs/components/controls/accordion)
