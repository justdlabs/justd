...
<How minW72 toUse="pickers/multiple-select-intent-demo" />

## Shape

Customize the tag field’s shape using the `shape` prop.

<How minW72 toUse="pickers/multiple-select-shape-demo" />

## Disabled
When the component is disabled, it prevents the user from adding or removing tags.
<How toUse="pickers/multiple-select-disabled-demo" />
