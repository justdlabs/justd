...
## Manual Installation
<InstallCommand isInstall isManual items={['react-aria-components', 'sonner', 'justd-icons']}/>
...
## Remix
If you're rocking this toast with Remix, you're gonna need setup somethings.

First, create a file named sonner.css and then paste the code from [here]('https://github.com/emilkowalski/sonner/blob/main/src/styles.css') into it and import into `ui/toast.tsx`.
