...
### Floating
The floating variation introduces an inner border within the sidebar, while the wrapper includes padding around the content. <NewTab href='/blocks/sidebar/sidebar-04'/>
```
<Sidebar intent="floating" />
```

### Fleet
The floating variation introduces an inner border within the sidebar, while the wrapper includes padding around the content. <NewTab href='/blocks/sidebar/sidebar-18'/>
<EditorText
  source={{
...
|---------------|----------------------------------------------------|-------------|
| `intent`      | `"default" \| "floating" \| \| "fleet" \| "inset"` | `"default"` |
