...
### Fleet
The float variation introduces an inner border within the sidebar, while the wrapper includes padding around the content. <NewTab href='/blocks/sidebar/sidebar-18'/>
<EditorText
  source={{
