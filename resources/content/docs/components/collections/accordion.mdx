...
<How isCenter={false} toUse="collections/accordion/accordion-demo" />
...
## Anatomy
<Anatomy show='accordion-anatomy'/>
...
<How isCenter={false} toUse="collections/accordion/accordion-default-expand-demo" />

## Hide Indicator
Eliminate the visual indicator (arrow key) by using the `hideIndicator` prop.
<How isCenter={false} toUse="collections/accordion/accordion-hide-indicator-demo" />
...
<How isCenter={false} toUse="collections/accordion/accordion-disabled-demo" />
