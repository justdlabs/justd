...
### Variables
You can customize your colors using these variables. By default, Justd utilizes OKLCH colors, but you have the option to switch to RGB, HSL, or HSB. If OKLCH isn't your preference, you can easily switch to another color format in the [Color Generator](/colors).
