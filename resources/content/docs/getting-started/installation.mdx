...
### Laravel
For Laravel, ensure [composer](https://getcomposer.org/download/) is installed first. Then, execute this command to create a new project:
<Code withImportCopy={false} lang='bash' code='composer create-project justd/laravel project-name'/>

### Next.js
The simplest way to start using Just D is through the [Next.js Starter Kit](https://justd-next.netlify.app/). This kit provides a pre-configured Next.js project, allowing you to get started immediately. To create a project, run this command:
<Code withImportCopy={false} lang='bash' code='npx create-next-app@latest -e https://github.com/justdlabs/next.js project-name'/>

### Remix
The simplest way to start using Just D is through the [Remix Starter Kit](https://github.com/justdlabs/remix). This kit provides a pre-configured Remix project, allowing you to get started immediately. This starter kit is creted by [José Miguel](https://github.com/m1guer).

Next, navigate to the project directory and run `npm i && npm run build`. Afterward, start your server with `php artisan serve`. Your setup is now complete.
