...
### Next.js
The simplest way to start using Just D is through the [Next.js Starter Kit](https://github.com/justdlabs/next.js). This kit provides a pre-configured Next.js project, allowing you to get started immediately. To create a project, run this command:
