...
<ManualInstall items={['react-aria-components', 'tailwindcss-react-aria-components']} />

Next, grab Tailwind Variant, Tailwind Merge, and clsx for those sweet utility functions.

<ManualInstall items={['tailwind-variants', 'tailwind-merge','clsx']} />

Then, snag the animation package for handling animations and Paranoid for icons:
<ManualInstall items={['@irsyadadl/paranoid', 'tailwindcss-animate', 'framer-motion']} />
