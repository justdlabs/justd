...
<Note intent='primary'>
  If you got other starter kits, like Remix or Vite, just drop a [PR](https://github.com/justdlabs/next/issues/new) and I'll slap it on the list.
</Note>
### Next.js
The easiest way to get started with Just D is to use the [Next.js Starter Kit](https://github.com/justdlabs/next). It's a Next.js project with justd all set up, so you can roll right away. Of just run this command:
<Code withImportCopy={false} lang='bash' code='npx create-next-app@latest -e https://github.com/justdlabs/next project-name'/>


### Laravel
For laravel, make sure you have [composer](https://getcomposer.org/download/) installed. Then, run this command:
<Code withImportCopy={false} lang='bash' code='composer create-project justd/laravel project-name'/>

Laravel's got this dope starter kit called Breeze, right? I've been rollin' with it for a minute. But now, I whipped up a Laravel Inertia.js starter kit with Justd baked in. It's got auth right outta the box, just like Breeze. Peep it [here](https://github.com/justdlabs/inertia.ts).
