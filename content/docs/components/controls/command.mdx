...
published: true
status: new
references: ["https://cmdk.paco.me/", "https://react-spectrum.adobe.com/react-aria/interactions.html#keyboard-and-focus-behavior"]
---

## Basic
This command is straightforward, always under your control, allowing you to open and close it as needed.
<How toUse="controls/command-demo" />

## Installation
<InstallCommand isAdd items={['command']}/>
...
<How toUse="controls/command-controlled-demo" />
...
<How toUse="controls/command-disabled-demo" />

## Hide Indicator
You can hide the search indicator by passing `withoutSearchIndicator` and close button by passing `withoutCloseButton`. The demo you can see on [Command Description](#description) section.
```
<Command
  withoutCloseButton
