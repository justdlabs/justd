...
## Link
Sometimes you need a link, right? Like, imagine you got a grid showing a list of articles. Sure, you could toss a link inside the group item, but check it, you can also slap a link directly on the grid item itself, like this:
```tsx
...
## Action
You can also hook up some actions to the grid item. Peep the real deal on the [Colors](/colors) page, where you can snag the color to your clipboard with the action button.
```tsx
