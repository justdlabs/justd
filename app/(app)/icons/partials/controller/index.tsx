  ...
  return (
    <div className="lg:sticky lg:top-20 z-10">
      <div className="relative">
        ...
        <div className="md:block hidden pointer-events-none z-0 absolute inset-x-0 top-0 -mt-5 h-24 bg-gradient-to-b from-background via-background/90 to-transparent" />
      </div>
    </div>
  )
}
