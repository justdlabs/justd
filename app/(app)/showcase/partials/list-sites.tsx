          ...
          {(item) => {
            return (
              <ListBoxItem
                rel="nofollow"
                target="_blank"
                className="flex items-center focus:outline-hidden focus-visible:ring-1 focus-visible:ring-ring gap-x-3 bg-secondary/70 hover:bg-secondary transition ring-1 ring-border rounded-lg px-3 py-2.5"
                textValue={item.name}
