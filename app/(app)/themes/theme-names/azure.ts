export const azure = {
  root: {
    ...
    "--chart-1": "205.77 100% 50%",
    "--chart-2": "201.2 100% 78%",
    "--chart-3": "207.75 100% 64%",
    "--chart-4": "199.38 95% 74%",
    "--chart-5": "200.6 94% 86%"
  },
  dark: {
    "--bg": "228.71 89% 2%",
    ...
    "--chart-1": "209.45 100% 42%",
    "--chart-2": "202.35 100% 73%",
    "--chart-3": "207.28 87% 57.99%",
    "--chart-4": "199.24 79% 69%",
    "--chart-5": "200.6 94% 86%"
  }
}
