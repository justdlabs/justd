  ...
  return (
    <div className="flex flex-col gap-2">
      <div className="bg-secondary p-4 rounded-xl border">
        ...
        <Description>
          Discover the best music festivals worldwide, bringing together iconic bands and emerging
          artists.
        </Description>
      </div>
      ...
      <div className="bg-tertiary p-4 rounded-xl border">
        ...
        <Description>
          Explore the rising stars of indie music and their fresh sound in today’s dynamic music
          scene.
        </Description>
      </div>
      ...
      <div className="bg-overlay p-4 rounded-xl border">
        ...
        <Description>
          Get a glimpse into the most memorable moments from top band tours around the globe.
        </Description>
      </div>
      ...
      <div className="bg-muted p-4 rounded-xl border">
        ...
        <Description>
          A look at the most legendary albums from bands that have shaped music history.
        </Description>
      </div>
